  ...
  return (
    <div className="sim-shell">
      ...
      <div className="sim-body">
        {error && (
          <div className="glass" style={{ padding: "14px 18px", color: "var(--signal)", fontSize: 14 }}>
            {error}
          </div>
        )}
        ...
        {phase === "pick" && (
          <>
            <div className="section-head" style={{ marginBottom: 8 }}>
              <div className="section-kicker">ESCOLHA O CENÁRIO</div>
              <h2>Qual objeção você quer treinar hoje?</h2>
            </div>
        ...
        {phase === "report" && report && scenario && (
          <div className="report-card glass">
            <div className="section-kicker">RELATÓRIO · {scenario.nome}</div>
